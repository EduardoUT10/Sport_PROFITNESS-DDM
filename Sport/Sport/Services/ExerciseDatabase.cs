    ...
    public class ExerciseDatabase
    {
        ...
        public async Task AddExercise()
        {
            ...
            if (bodyParts.Count == 0)
            {
                ...
                await SaveExerciseAsync(new Exercise { Name = "Push Up", Source = "pushUp.gif", isEdit = false, BodyPartsExercise = "pectorals | triceps | shoulders", Difficulty = "Facil", ColorDifficulty = "#32cd32", DateTime = DateTime.Now, Favorite = true, Description = "El push-up es un ejercicio de entrenamiento de fuerza que involucra principalmente al pectoral mayor, deltoides y tríceps. Este ejercicio es popular porque se puede realizar en cualquier lugar y no requiere equipo." });
