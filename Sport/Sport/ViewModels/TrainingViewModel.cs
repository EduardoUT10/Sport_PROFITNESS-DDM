...
namespace Sport.ViewModels
{
    public class TrainingViewModel : BaseViewModel
    {
        ...
        private string _day = $"Dia {DateTime.Now.Day}";
        ...
        {
            if(DateTime.Now.Day.ToString() != _day.Replace("Dia ",""))
            {
                Date = DateTime.Now.Date.ToString();
                TextDay = $"Dia {DateTime.Now.Day}";
            }
        ...
        private void CreateTrainingDay()
        {
            for(int i= 1; i<DateTime.DaysInMonth(DateTime.Now.Year, DateTime.Now.Month)+1; i++)
            {
                if (i != DateTime.Now.Day)
                {
                    ...
                    if (i < DateTime.Now.Day)
                    {
                        button.Text = "ver mi dia de entrenamiento";
                        button.TextColor = Color.White;
                        button.BackgroundColor = Color.FromHex("#1155fc");
                    ...
                    {
                        button.Text = "Nos volveremos a ver";
